...
export default function PrintOrder({ params }: Props) {
	...
	if (!orderDetails) return <p className='text-center text-lg md:text-xl font-semibold pt-20 md:pt-16'>Order not found ...</p>

	return (
		<div className='pb-20 md:pb-24 md:pt-6 pt-4 max-w-4xl mx-auto'>
			<div className='rounded-3xl md:py-10 md:px-14 py-8 px-6 bg-brand-secondary/10 md:space-y-6 space-y-4'>
